...
class Node23 {
    var numItems: Int = 0
        private set
    var parent: Node23? = null
        private set
    private val childArray = arrayOfNulls<Node23>(ORDER)
    ...
    fun connectChild(childNum: Int, child: Node23?) {
        childArray[childNum] = child
        if (child != null)
            child.parent = this
    }

    fun disconnectChild(childNum: Int): Node23? {
        val tempNode = childArray[childNum]
        childArray[childNum] = null
        return tempNode
    }

    fun getChild(childNum: Int): Node23? {
